...
try: 
	...
	raise MissingPythonDependencyError("Please install NumPy if you want to use the PDB parser.")
		...
		for i in range(0, len(coords_trailer)): 
			...
			if record_type == "ATOM  " or record_type == "HETATM": 
				...
				if len(split_list) != 1: 
					...
					name = split_list[0] 
				altloc = line[16] 
				resname = line[17:21] # CHANGED BY RVM (ALLOWS TO USE FOUR LETTER CODES)
				chainid = line[21] 
				try: 
